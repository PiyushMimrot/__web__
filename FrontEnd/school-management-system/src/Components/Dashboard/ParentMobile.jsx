                            ...
                            {recentAssignment?.map((item) => (
                              ...
                              >
                                <TodoCard
                                  ...
                                  date={"Due: " + item?.last_date?.slice(0, 10)}
                                  desc={
                                    // a.length > 3 &&
                                    // "Desc: " + a.slice(0, 18) + "..."
                                    "...."
                            ...
                            {upcomingExams?.map((item) => (
                              ...
                              >
                                <TodoCard
                                  ...
                                  date={"On: " + item?.exam_date?.slice(0, 10)}
                                  desc={
                                    // a.length > 3 &&
                                    // "Desc: " + a.slice(0, 18) + "..."
                                    "...."
                                  ...
                                  badge={
                                    item?.exam_time ? item.exam_time : "No data"
                                  }
                                />
                              </div>
                            ))}
                              ...
                              <button
                                ...
                                title={
                                  item.status
                                    ...
                                    : "Asked on " + item?.createdAt.slice(0, 10)
                                }
                              >
              ...
              <SubjectAnalytics
                ...
                data={{
                  myavg: averages?.studentCount
                    ? (
                        averages?.studentCount / studentExamperformance?.length
                      )?.toFixed(2)
                    : "00.00",
                  classavg: studentExamperformance
                    ? (
                        averages?.avgMarksSum / studentExamperformance?.length
                      )?.toFixed(2)
                    : 0,
                }}
              />
